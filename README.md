...
[![YT-DLP](https://raw.githubusercontent.com/kclauhk/yt-dlp/master/.github/banner.svg)](#readme)

[![Release version](https://img.shields.io/github/v/release/kclauhk/yt-dlp?color=brightgreen&label=Latest&style=for-the-badge)](#installation "Installation")
[![Python Version](https://img.shields.io/python/required-version-toml?tomlFilePath=https%3A%2F%2Fraw.githubusercontent.com%2Fkclauhk%2Fyt-dlp%2Frefs%2Fheads%2Fmaster%2Fpyproject.toml&style=for-the-badge)](https://github.com/kclauhk/yt-dlp/blob/master/pyproject.toml "Python Version")
[![Supported Sites](https://img.shields.io/badge/-Supported_Sites-%235865F2.svg?style=for-the-badge)](supportedsites.md "Supported Sites")
...
The public key that can be used to verify the GPG signatures is [available here](https://github.com/kclauhk/yt-dlp/blob/master/public.key)
Example usage:
```
curl -L https://github.com/kclauhk/yt-dlp/raw/master/public.key | gpg --import
...
The available fields are:
 ...
 - `acodec`: Audio Codec (`flac`/`alac` > `wav`/`aiff` > `opus` > `vorbis` > `aac` > `mp4a` > `mp3` > `ac4` > `eac3` > `ac3` > `dts` > `iamf` > other)
