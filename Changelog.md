...
#### Core changes
- [Add `--check-video-formats` and `--probe-formats` options](https://github.com/yt-dlp/yt-dlp/commit/486a4d0391757702cddb8880a06beff30fc45d4e) by [pukkandan](https://github.com/pukkandan)
- [Update README.md](https://github.com/yt-dlp/yt-dlp/commit/fe4f33021a4264cbc8c05d05aa55407312eb0007) by [pukkandan](https://github.com/pukkandan)
- [Use ffprobe to check format if media properties are not available](https://github.com/yt-dlp/yt-dlp/commit/a5ddba6c077aa3efa55a83510f1e89d725cb0f68) by [pukkandan](https://github.com/pukkandan)
