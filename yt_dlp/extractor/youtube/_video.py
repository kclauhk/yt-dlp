...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    _TESTS = [{
        ...
        'params': {'skip_download': True},
        'skip': 'This live stream recording is not available',
    }, {
        ...
        'info_dict': {
            ...
            'description': 'md5:922657801989340fd040fcf5a97da516',
            'media_type': 'video',
            'uploader': 'half•alive',
            'channel': 'half•alive',
    ...
    def _extract_formats_and_subtitles(self, video_id, player_responses, player_url, live_status, duration):
        ...
        for pr in player_responses:
            ...
            def process_manifest_format(f, proto, client_name, itag, missing_pot):
                ...
                if client_name in ('web_safari', 'web_embedded') and proto == 'hls':
                    f['format_note'] = join_nonempty(f.get('format_note'), 'HLS', delim=' ')
