...
class FacebookIE(InfoExtractor):
    ...
    def _extract_from_url(self, url, video_id):
        ...
        title = (info_json_ld.get('title') or title or '').split(' | ')[0]
            ...
            if data:
                ...
                def parse_graphql_video(video):
                    ...
                    for url in [uri for uri in [traverse_obj(
                        ...
                        webpage_info['thumbnails'].append({k: v for k, v in {
                            'url': url,
                    ...
                    info = {
                        'id': v_id,
                        'title': video.get('name') or webpage_info['title'] or f'Facebook video #{v_id}',
                ...
                if 'Facebook video #' in video_info['title'] and (title or video_info['uploader']):
