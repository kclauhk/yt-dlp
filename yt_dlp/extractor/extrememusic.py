...
class ExtremeMusicIE(ExtremeMusicBaseIE):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            ...
            'track_number': 5,
            'track_id': 'HPE316_05',
            'description': r're:a emotive, chill and reflective pop track with a medium tempo',
            'artists': ['PRAERS'],
        ...
        'info_dict': {
            ...
            'track_number': 2,
            'track_id': 'ASM0002_02',
            'description': r're:a fun, happy and upbeat pop track with a medium - fast tempo',
            'composers': ['ENB'],
        ...
        'info_dict': {
            ...
            'track_number': 2,
            'track_id': 'HPE263_02',
            'description': r're:a fun, sexy and confident pop track with a medium tempo',
