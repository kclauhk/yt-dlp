...
class IdoltvIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            'id': '5943-3-2',
            'title': '摸心第六感 | 第2集',
            'description': 'md5:3d0a526334122948780ee56efb6b4c57',
            'episode': '第2集',
            ...
            'cast': ['韓志旼', '李民基', '金俊勉', '周敏京'],
            'ext': 'mp4',
            'duration': 4005.79 if FFmpegPostProcessor().probe_available else None,
        },
    }]
        ...
        if player_data['from'] == 'bilibili':
            ...
            if f:
                ...
                if f[0]['url'].count('.haiwaikan.com') > 0:
                    # ‘雲播15’ provides lesser info but usually higher resolution and faster download speed
                    f[0]['preference'] = 1
