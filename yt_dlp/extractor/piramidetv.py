...
class PiramideTVIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        def extract_video(video_id, fatal=False):
            ...
            video_info = {**traverse_obj(video_data, ('video', {
                'id': ('id', {str}),
                'title': ('title', {str}),
...
class PiramideTVChannelURLIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        return self.url_result(url=f'piramidetvall:{channel_name}', url_transparent=True)
...
class PiramideTVChannelIE(SearchInfoExtractor):
    ...
    def _search_results(self, query):
        videos = self._download_json(
            f'https://hermes.piramide.tv/channel/list/{query}/date/100000', query)
