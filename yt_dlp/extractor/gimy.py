...
class GimyIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        vid, source_id, episode_id, source_la, episode_la = self._match_valid_url(url).group('id', 'source_id', 'episode_id', 'source_la', 'episode_la')
        sid, eid = (source_id or source_la, episode_id or episode_la)
...
class GimyDetailIE(GimyIE):
    ...
    _TESTS = [{
        ...
        'info_dict': {
            'id': '100699',
            'title': '工作細胞black',
            'description': 'md5:967c45130a4bfa9e82f0f7780c9306f2',
            'thumbnail': r're:https?://.*',
            'release_year': 2021,
            'categories': ['動漫'],
            'location': '日本',
