...
class VMwareIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.vmware.com/video/6367980365112',
        'info_dict': {
            'id': '6367980365112',
            'ext': 'mp4',
            'title': 'PrivateAI Explainer Video',
            'description': r're:Bring AI models to your trusted data, ',
            'thumbnail': r're:https?://.*/image\.jpg',
            'tags': 'count:7',
            'timestamp': 1738213660,
...
class VMwareExploreIE(InfoExtractor):
    ...
    _TESTS = [{
        'url': 'https://www.vmware.com/explore/video-library/video/6377276035112',
        'info_dict': {
            'id': '6377276035112',
            'ext': 'mp4',
            'title': 'GEN2027LV',
            'description': r're:Shaping the Future of Private Cloud and AI Innovation',
            'thumbnail': r're:https?://.*/image\.jpg',
            'tags': 'count:5',
            'timestamp': 1755908633,
