...
class BilibiliBaseIE(InfoExtractor):
    ...
    def extract_formats(self, play_info):
        ...
        for audio in audios:
            for url in sorted(dict.fromkeys(traverse_obj(
                    audio, (('baseUrl', 'base_url', (('backupUrl', 'backup_url'), ...), 'url'), {url_or_none})))):
                formats.append({
                    'url': url,
        ...
        for video in traverse_obj(play_info, ('dash', 'video', ...)):
            for url in sorted(dict.fromkeys(traverse_obj(
                    video, (('baseUrl', 'base_url', (('backupUrl', 'backup_url'), ...), 'url'), {url_or_none})))):
                formats.append({
                    'url': url,
