                ...
                try:
                    ...
                    if challenge_type(tab.html):
                        ...
                        for _ in range(timeout):
                            if challenge_type(tab.html) == 'turnstile':
                ...
                if not self._browser or self._browser.stopped:
                    ...
                    try:
                        ...
                        self._downloader.report_error(
                            f'{video_id}: {errmsg}: {err} (caused by <{err.__class__.__name__}>)')
                            ...
                            if data := self._search_json(
                                ...
                                if chl_type == 'turnstile':
                                    ...
                                    await asyncio.wait_for(
                                        cf_verify.verify(
                                            _max_retries=timeout,
                                            _interval_between_retries=1,
                                            _reload_page_after_n_retries=timeout),
                                        timeout=timeout * 2)
                            elif (evaluate(html)
                                  or not self._new_response
                    ...
                    try:
                        ...
                        if (hasattr(err, 'cause')
                            ...
                            raise ExtractorError(
                                ...
                                'a) DrissionPage (https://pypi.org/project/DrissionPage/), or '
                                'b) nodriver 0.47.0 (https://pypi.org/project/nodriver/0.47.0/) and '
